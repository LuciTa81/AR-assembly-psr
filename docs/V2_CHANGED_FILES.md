...
YOLO driver/handle/screw bbox를 warped 좌표계로 변환하고 `tool_near_a/b/c/d` 및 screw 보조 score를 생성합니다.
...
- server/vision/yolo_infer_session.py: driver 단일 class에서 `driver,handle,screw` 3-class 필터 지원으로 확장했습니다.
