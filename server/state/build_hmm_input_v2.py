...
YOLO_COLS=["tool_visible","tool_confidence","tool_detection_count","tool_inside_workspace","tool_x","tool_y","tool_tip_x","tool_tip_y","tool_dist_a","tool_dist_b","tool_dist_c","tool_dist_d","tool_near_a","tool_near_b","tool_near_c","tool_near_d","chosen_screw"]
...
def add_smoothing(df, window, seen_threshold):
    ...
    for prefix in ["tool_near","index_near"]:
        for k in ["a","b","c","d"]:
            ...
            df[seen]=(df[sm]>=seen_threshold).cummax().astype(int)
